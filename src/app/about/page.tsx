      ...
      <section className="border-b bg-gradient-to-b from-blue-50/80 to-white py-10 md:py-14">
        <div className="mx-auto max-w-2xl px-4">
          <nav aria-label="パンくずリスト" className="mb-4 flex items-center gap-1 text-sm text-muted-foreground">
            ...
            <span className="text-foreground">ヤメラボについて</span>
          </nav>
      ...
      <div className="mx-auto max-w-2xl space-y-6 px-4 py-10 md:py-14">
        <Card>
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold">ヤメラボとは</h2>
        ...
        <Card>
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold">アフィリエイト広告について</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              {CONTACT_FORM_URL ? (
                <p>
                  ...
                  <a
                    ...
                    className="cursor-pointer text-primary underline transition-colors duration-200 hover:text-primary/80"
                  >
                    お問い合わせフォーム
                  </a>
                </p>
